...
export async function GET(req, { params }) {
  ...
  return Response.json({
    profile: {
      ...
      twitterHandle: user.twitterHandle || user.twitter || null,
      instagramHandle: user.instagram || null,
      youtubeHandle: user.youtube || null,
      tradingviewHandle: user.website || null,
      profileSlug: user.profileSlug,
