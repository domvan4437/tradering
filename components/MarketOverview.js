    ...
    sectors: [
      {
        ...
        assets: [
          ...
          { sym:'PA=F',  name:'Palladium', unit:'$/troy oz' },
          { sym:'MGC=F', name:'Micro Gold', unit:'$/troy oz' },
        ],
      },
      {
        ...
        assets: [
          ...
          { sym:'BZ=F',  name:'Crude Oil Brent',unit:'$/barrel' },
          { sym:'NG=F',  name:'Natural Gas',    unit:'$/MMBtu'  },
          { sym:'RB=F',  name:'RBOB Gasoline',  unit:'$/gallon' },
          { sym:'HO=F',  name:'Heating Oil',    unit:'$/gallon' },
          { sym:'MCL=F', name:'Micro Crude',     unit:'$/barrel' },
        ],
      },
      {
        name: 'Grains', exchange: 'CBOT', color: '#16a34a',
        assets: [
          { sym:'ZW=F', name:'Wheat',       unit:'c/bu'  },
          { sym:'ZC=F', name:'Corn',        unit:'c/bu'  },
          { sym:'ZS=F', name:'Soybeans',    unit:'c/bu'  },
          { sym:'ZO=F', name:'Oats',        unit:'c/bu'  },
          { sym:'ZR=F', name:'Rough Rice',  unit:'$/cwt' },
          { sym:'ZL=F', name:'Soybean Oil', unit:'c/lb'  },
          { sym:'ZM=F', name:'Soybean Meal',unit:'$/ton' },
          { sym:'KE=F', name:'HRW Wheat',   unit:'c/bu'  },
        ],
      },
      {
        name: 'Softs', exchange: 'ICE', color: '#8b5cf6',
        assets: [
          { sym:'CT=F',  name:'Cotton',       unit:'c/lb'  },
          { sym:'KC=F',  name:'Coffee',       unit:'c/lb'  },
          { sym:'SB=F',  name:'Sugar',        unit:'c/lb'  },
          { sym:'CC=F',  name:'Cocoa',        unit:'$/ton' },
          { sym:'OJ=F',  name:'Orange Juice', unit:'c/lb'  },
          { sym:'LBS=F', name:'Lumber',        unit:'$/MBF' },
        ],
      },
      {
        name: 'Livestock', exchange: 'CME', color: '#dc2626',
        assets: [
          { sym:'LE=F', name:'Live Cattle',   unit:'c/lb' },
          { sym:'GF=F', name:'Feeder Cattle', unit:'c/lb' },
          { sym:'HE=F', name:'Lean Hogs',     unit:'c/lb' },
        ],
      },
    ],
    news: [
    ...
    sectors: [
      {
        ...
        assets: [
          ...
          { sym:'NQ=F',   name:'E-mini Nasdaq 100',  unit:'pts' },
          { sym:'YM=F',   name:'E-mini Dow Jones',   unit:'pts' },
          { sym:'RTY=F',  name:'E-mini Russell 2000', unit:'pts' },
          { sym:'MES=F',  name:'Micro E-mini S&P',    unit:'pts' },
          { sym:'MNQ=F',  name:'Micro E-mini Nasdaq', unit:'pts' },
          { sym:'VX=F',   name:'VIX Futures',         unit:'pts' },
        ],
      },
      {
        ...
        assets: [
          ...
          { sym:'GE=F', name:'Eurodollar',   unit:'pts' },
        ],
      },
      {
        ...
        assets: [
          ...
          { sym:'6C=F', name:'Canadian Dollar',    unit:'$/CAD' },
          { sym:'6S=F', name:'Swiss Franc',        unit:'$/CHF' },
          { sym:'6N=F', name:'New Zealand Dollar',unit:'$/NZD' },
        ],
      },
    ],
    news: [
    ...
    sectors: [
      {
        ...
        assets: [
          ...
          { sym:'USDSEK=X', name:'USD/SEK', unit:'per USD' },
          { sym:'USDNOK=X', name:'USD/NOK', unit:'per USD' },
          { sym:'USDMXN=X', name:'USD/MXN', unit:'per USD' },
        ],
      },
      {
        ...
        assets: [
          ...
          { sym:'EURAUD=X', name:'EUR/AUD', unit:'cross' },
          { sym:'EURCAD=X', name:'EUR/CAD', unit:'cross' },
          { sym:'GBPJPY=X', name:'GBP/JPY', unit:'cross' },
          { sym:'GBPAUD=X', name:'GBP/AUD', unit:'cross' },
          { sym:'AUDJPY=X', name:'AUD/JPY', unit:'cross' },
          { sym:'CADJPY=X', name:'CAD/JPY', unit:'cross' },
          { sym:'USDZAR=X', name:'USD/ZAR', unit:'exotic' },
          { sym:'USDTRY=X', name:'USD/TRY', unit:'exotic' },
        ],
      },
    ],
    news: [
    ...
    sectors: [
      {
        ...
        assets: [
          ...
          { sym:'AMD',   name:'AMD',         unit:'USD' },
          { sym:'INTC',  name:'Intel',       unit:'USD' },
          { sym:'CRM',   name:'Salesforce',  unit:'USD' },
          { sym:'ORCL',  name:'Oracle',      unit:'USD' },
          { sym:'ADBE',  name:'Adobe',       unit:'USD' },
          { sym:'QCOM',  name:'Qualcomm',    unit:'USD' },
          { sym:'AVGO',  name:'Broadcom',    unit:'USD' },
          { sym:'TSM',   name:'TSMC',        unit:'USD' },
          { sym:'ASML',  name:'ASML',        unit:'USD' },
        ],
      },
      {
        name: 'Finance', exchange: 'NYSE', color: '#0891b2',
        assets: [
          { sym:'JPM',   name:'JPMorgan Chase',   unit:'USD' },
          { sym:'BAC',   name:'Bank of America',  unit:'USD' },
          { sym:'GS',    name:'Goldman Sachs',    unit:'USD' },
          { sym:'MS',    name:'Morgan Stanley',   unit:'USD' },
          { sym:'WFC',   name:'Wells Fargo',      unit:'USD' },
          { sym:'C',     name:'Citigroup',        unit:'USD' },
          { sym:'BLK',   name:'BlackRock',        unit:'USD' },
          { sym:'V',     name:'Visa',             unit:'USD' },
          { sym:'MA',    name:'Mastercard',       unit:'USD' },
          { sym:'AXP',   name:'American Express', unit:'USD' },
          { sym:'BRK-B', name:'Berkshire B',       unit:'USD' },
          { sym:'SCHW',  name:'Charles Schwab',   unit:'USD' },
        ],
      },
      {
        ...
        assets: [
          ...
          { sym:'EOG',  name:'EOG Resources',    unit:'USD' },
          { sym:'SLB',  name:'SLB',              unit:'USD' },
          { sym:'OXY',  name:'Occidental',       unit:'USD' },
          { sym:'PSX',  name:'Phillips 66',      unit:'USD' },
          { sym:'MPC',  name:'Marathon Petro',   unit:'USD' },
        ],
      },
      {
        name: 'Healthcare', exchange: 'NYSE/NASDAQ', color: '#10b981',
        assets: [
          { sym:'JNJ',  name:'Johnson & Johnson', unit:'USD' },
          { sym:'UNH',  name:'UnitedHealth',      unit:'USD' },
          { sym:'LLY',  name:'Eli Lilly',         unit:'USD' },
          { sym:'PFE',  name:'Pfizer',            unit:'USD' },
          { sym:'MRK',  name:'Merck',             unit:'USD' },
          { sym:'ABBV', name:'AbbVie',            unit:'USD' },
          { sym:'TMO',  name:'Thermo Fisher',     unit:'USD' },
          { sym:'AMGN', name:'Amgen',             unit:'USD' },
        ],
      },
      {
        name: 'Consumer', exchange: 'NYSE/NASDAQ', color: '#d97706',
        assets: [
          { sym:'TSLA', name:'Tesla',       unit:'USD' },
          { sym:'WMT',  name:'Walmart',     unit:'USD' },
          { sym:'HD',   name:'Home Depot',  unit:'USD' },
          { sym:'MCD',  name:'McDonald s',  unit:'USD' },
          { sym:'NKE',  name:'Nike',        unit:'USD' },
          { sym:'SBUX', name:'Starbucks',   unit:'USD' },
          { sym:'COST', name:'Costco',      unit:'USD' },
          { sym:'TGT',  name:'Target',      unit:'USD' },
        ],
      },
      {
        name: 'ETFs & Indices', exchange: 'NYSE/NASDAQ', color: '#7c3aed',
        assets: [
          { sym:'SPY',  name:'S&P 500 ETF',     unit:'USD' },
          { sym:'QQQ',  name:'Nasdaq 100 ETF',  unit:'USD' },
          { sym:'DIA',  name:'Dow Jones ETF',   unit:'USD' },
          { sym:'IWM',  name:'Russell 2000 ETF', unit:'USD' },
          { sym:'GLD',  name:'Gold ETF',         unit:'USD' },
          { sym:'TLT',  name:'20Y Bond ETF',     unit:'USD' },
          { sym:'XLE',  name:'Energy ETF',       unit:'USD' },
          { sym:'XLF',  name:'Financials ETF',   unit:'USD' },
        ],
      },
    ],
    news: [
    ...
    sectors: [
      {
        ...
        assets: [
          ...
          { sym:'DOT-USD',  name:'Polkadot',  unit:'USD' },
          { sym:'ATOM-USD', name:'Cosmos',    unit:'USD' },
          { sym:'NEAR-USD', name:'NEAR',      unit:'USD' },
          { sym:'APT-USD',  name:'Aptos',     unit:'USD' },
          { sym:'SUI-USD',  name:'Sui',       unit:'USD' },
        ],
      },
      {
        name: 'DeFi', exchange: 'SPOT', color: '#8b5cf6',
        assets: [
          { sym:'UNI-USD',  name:'Uniswap',   unit:'USD' },
          { sym:'AAVE-USD', name:'Aave',      unit:'USD' },
          { sym:'MKR-USD',  name:'Maker',     unit:'USD' },
          { sym:'LDO-USD',  name:'Lido DAO',  unit:'USD' },
        ],
      },
      {
        name: 'Payments', exchange: 'SPOT', color: '#10b981',
        assets: [
          { sym:'XRP-USD',  name:'XRP',       unit:'USD' },
          { sym:'BNB-USD',  name:'BNB',       unit:'USD' },
          { sym:'DOGE-USD', name:'Dogecoin',  unit:'USD' },
          { sym:'SHIB-USD', name:'Shiba Inu', unit:'USD' },
...
const MOCK_COT = {
  'GC=F':82,'SI=F':54,'HG=F':38,'PL=F':45,'PA=F':29,'MGC=F':82,
  'CL=F':31,'BZ=F':33,'NG=F':78,'RB=F':42,'HO=F':39,'MCL=F':31,
  'ZW=F':67,'ZC=F':55,'ZS=F':73,'ZO=F':48,'ZR=F':52,'ZL=F':61,'ZM=F':58,'KE=F':64,
  'CT=F':44,'KC=F':71,'SB=F':38,'CC=F':82,'OJ=F':56,'LBS=F':33,
  'LE=F':62,'GF=F':57,'HE=F':41,
  'ES=F':61,'NQ=F':65,'YM=F':58,'RTY=F':47,'MES=F':61,'MNQ=F':65,'VX=F':72,
  'ZB=F':38,'ZN=F':42,'ZF=F':45,'ZT=F':51,'GE=F':55,
  '6E=F':44,'6B=F':52,'6J=F':28,'6A=F':39,'6C=F':48,'6S=F':61,'6N=F':43,
  'EURUSD=X':44,'GBPUSD=X':52,'USDJPY=X':28,'AUDUSD=X':39,
  'USDCAD=X':48,'USDCHF=X':61,'NZDUSD=X':43,'USDSEK=X':55,'USDNOK=X':49,'USDMXN=X':37,
  'EURGBP=X':46,'EURJPY=X':35,'EURAUD=X':41,'EURCAD=X':53,
  'GBPJPY=X':33,'GBPAUD=X':44,'AUDJPY=X':38,'CADJPY=X':42,
  'USDZAR=X':26,'USDTRY=X':19,
  'BTC-USD':71,'ETH-USD':68,'SOL-USD':74,'ADA-USD':52,
  'AVAX-USD':61,'DOT-USD':45,'ATOM-USD':58,'NEAR-USD':63,'APT-USD':55,'SUI-USD':67,
  'UNI-USD':49,'AAVE-USD':57,'MKR-USD':62,'CRV-USD':41,'LDO-USD':66,
  'XRP-USD':58,'BNB-USD':64,'DOGE-USD':72,'SHIB-USD':68,'LTC-USD':51,
  'MATIC-USD':53,'ARB-USD':61,'OP-USD':58,'FET-USD':69,'RNDR-USD':74,'TAO-USD':77,
  'AAPL':62,'MSFT':68,'NVDA':81,'GOOGL':59,'META':73,'AMZN':65,
  'AMD':76,'INTC':38,'CRM':57,'ORCL':61,'ADBE':54,'QCOM':48,'AVGO':71,'TSM':66,'ASML':69,
  'JPM':58,'BAC':44,'GS':62,'MS':55,'WFC':41,'C':37,
  'BLK':64,'V':72,'MA':74,'AXP':59,'BRK-B':67,'SCHW':48,
  'XOM':52,'CVX':56,'COP':61,'EOG':58,'SLB':44,'OXY':49,'PSX':53,'MPC':47,
  'JNJ':63,'UNH':71,'LLY':84,'PFE':39,'MRK':57,'ABBV':62,'TMO':68,'AMGN':55,
  'TSLA':74,'WMT':65,'HD':61,'MCD':58,'NKE':52,'SBUX':46,'COST':69,'TGT':43,
  'SPY':61,'QQQ':65,'DIA':58,'IWM':47,'GLD':79,'TLT':38,'XLE':52,'XLF':55,
};
